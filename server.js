...
//app.use(upload());
//var upload=multer({dest:'https://filestore.allegorically70.hasura-app.io/'});
/* app.use(session({
...
app.post("/signup",urlencodedParser,function(req,res){
  ...
  var options = {
     method: 'POST',
    url: 'https://auth.allegorically70.hasura-app.io/signup',
    headers:
     {
...
request(options, function (error, response, body) {
    ...
    if(code==200){
     ...
     var options = { method: 'POST',
       url: 'https://data.allegorically70.hasura-app.io/v1/query',
       headers:
        {
          'cache-control': 'no-cache',
...
app.post("/login",urlencodedParser,function(req,res){
  ...
  console.log(password);
    ...
    req.open('POST', 'https://auth.allegorically70.hasura-app.io/login', true); // force XMLHttpRequest2
...
var options = { method: 'POST',
  url: 'https://auth.allegorically70.hasura-app.io/user/logout',
  headers:
...
var cookie_id = req.cookies.randomcookiename.auth_token;
  ...
  var options = { method: 'POST',
    url: 'https://filestore.allegorically70.hasura-app.io/v1/file/'+imgpath,
    body: imge,
    headers:
  ...
  var htmlTemplate=` 
        <div class="col-xs-12 col-sm-3" style="padding-bottom:50px;">
          ...
          <a class="img-card"  href="javascript:myFunction('${Ad_id}')" >
            <img src="https://filestore.allegorically70.hasura-app.io/v1/file/${Ad_id}" style="height: 100%;">
          </a>
  ...
  var newtemplate= `
					...
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img style="width:700px" src="https://filestore.allegorically70.hasura-app.io/v1/file/${Ad_id}"></div>
						 
						</div>
						<ul class="preview-thumbnail nav nav-tabs">
						  <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="https://filestore.allegorically70.hasura-app.io/v1/file/${Ad_id}" /></a></li>
